...
var LightsT = function() {
	...
	//
	var u_pos 	= new Array(false, false, false, false, false);					// GPU locations for 'uniform' that holds I_pos
	var u_ambi 	= new Array(false, false, false, false, false);						// 																			 I_ambi
	var u_diff 	= new Array(false, false, false, false, false);						//																			 I_diff
	var u_spec 	= new Array(false, false, false, false, false);						//																			 I_spec.
